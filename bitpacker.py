...
def pack(temperatura, direccion, oxigeno):
    maskoxi = bitarray('000111111100000000000000')
    oxigenbuff = (int2ba(oxigeno, 24)<<14)&maskoxi
    ...
    return oxigenbuff|dirbuff|tempbuff
